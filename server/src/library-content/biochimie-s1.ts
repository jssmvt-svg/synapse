...
import {
  ...
  LAB12_LEARNING,
  LAB13_LEARNING,
} from "./biochimie-labo-10-11-12-13.js";
...
export const BIOCHIMIE_S1: LibraryChapterSeed[] = [
  ...
  // Chapitres de laboratoire (section "laboratoire"), numérotés comme les
  // notes source de l'utilisatrice (Lab 2 à Lab 13). L'ordre part de 102 pour
  // ne jamais entrer en collision avec les chapitres de cours (ordre 1-11).
  {
    ordre: 102,
    section: "laboratoire",
    titre_fr: "Mesures de masse, volume et densité",
    titre_en: "Mass, Volume and Density Measurements",
    description_fr: "Unités SI, instruments de pesée et de mesure de volume, densité urinaire",
    description_en: "SI units, weighing and volume measurement instruments, urine density",
    icone: "⚖️",
    learning: LAB2_LEARNING,
    cards: [],
  },
  {
    ordre: 103,
    section: "laboratoire",
    titre_fr: "Solutions, dilutions et isotonicité",
    titre_en: "Solutions, Dilutions and Isotonicity",
    description_fr: "Concentrations, calculs de dilution et osmolarité des solutions de perfusion",
    description_en: "Concentrations, dilution calculations and osmolarity of infusion solutions",
    icone: "💧",
    learning: LAB3_LEARNING,
    cards: [],
  },
  {
    ordre: 104,
    section: "laboratoire",
    titre_fr: "Acides, bases et titration acide-base",
    titre_en: "Acids, Bases and Acid-Base Titration",
    description_fr: "Autoionisation de l'eau, force des acides/bases, pH et méthodes de titration volumétrique",
    description_en: "Water autoionization, acid/base strength, pH and volumetric titration methods",
    icone: "⚗️",
    learning: LAB4_LEARNING,
    cards: [],
  },
  {
    ordre: 105,
    section: "laboratoire",
    titre_fr: "pH des fluides biologiques et point isoélectrique",
    titre_en: "pH of Biological Fluids and Isoelectric Point",
    description_fr: "Calculs de pH (acides/bases forts et faibles), méthodes de détermination, point isoélectrique des acides aminés",
    description_en: "pH calculations (strong/weak acids and bases), determination methods, isoelectric point of amino acids",
    icone: "🧪",
    learning: LAB5_LEARNING,
    cards: [],
  },
  {
    ordre: 106,
    section: "laboratoire",
    titre_fr: "Systèmes tampons biologiques",
    titre_en: "Biological Buffer Systems",
    description_fr: "Équation de Henderson-Hasselbalch, tampons sanguins, équilibre acido-basique",
    description_en: "Henderson-Hasselbalch equation, blood buffers, acid-base balance",
    icone: "🧫",
    learning: LAB6_LEARNING,
    cards: [],
  },
  {
    ordre: 107,
    section: "laboratoire",
    titre_fr: "Centrifugation et fluides biologiques",
    titre_en: "Centrifugation and Biological Fluids",
    description_fr: "Principe de la centrifugation, types de prélèvements sanguins et tubes de collecte",
    description_en: "Centrifugation principle, blood sampling types and collection tubes",
    icone: "🩸",
    learning: LAB7_LEARNING,
    cards: [],
  },
  {
    ordre: 108,
    section: "laboratoire",
    titre_fr: "Chromatographie et séparation des acides aminés",
    titre_en: "Chromatography and Amino Acid Separation",
    description_fr: "Principes de la chromatographie, mécanismes de séparation et chromatographie sur papier",
    description_en: "Chromatography principles, separation mechanisms and paper chromatography",
    icone: "🧬",
    learning: LAB8_LEARNING,
    cards: [],
  },
  {
    ordre: 109,
    section: "laboratoire",
    titre_fr: "Protéines : dialyse et électrophorèse",
    titre_en: "Proteins: Dialysis and Electrophoresis",
    description_fr: "Principes de la dialyse, applications médicales et électrophorèse des protéines sériques",
    description_en: "Dialysis principles, medical applications and serum protein electrophoresis",
    icone: "🩹",
    learning: LAB9_LEARNING,
    cards: [],
  },
  {
    ordre: 110,
    section: "laboratoire",
    titre_fr: "Spectrophotométrie et dosage des protéines",
    titre_en: "Spectrophotometry and Protein Assay",
    description_fr: "Loi de Beer-Lambert, courbes d'étalonnage et dosage optique des protéines sériques",
    description_en: "Beer-Lambert law, calibration curves and optical assay of serum proteins",
    icone: "📈",
    learning: LAB10_LEARNING,
    cards: [],
  },
  {
    ordre: 111,
    section: "laboratoire",
    titre_fr: "Enzymes et test optique : dosage de la LDH",
    titre_en: "Enzymes and Optical Test: Serum LDH Assay",
    description_fr: "Cofacteurs enzymatiques, isoenzymes de la LDH, transaminases et créatine kinase",
    description_en: "Enzyme cofactors, LDH isoenzymes, transaminases and creatine kinase",
    icone: "🔬",
    learning: LAB11_LEARNING,
    cards: [],
  },
  {
    ordre: 112,
    section: "laboratoire",
    titre_fr: "Dosage de la vitamine C par iodométrie",
    titre_en: "Vitamin C Assay by Iodometry",
    description_fr: "Titration redox, structure et rôles biologiques de l'acide ascorbique",
    description_en: "Redox titration, structure and biological roles of ascorbic acid",
    icone: "🍊",
    learning: LAB12_LEARNING,
    cards: [],
  },
  {
    ordre: 113,
    section: "laboratoire",
    titre_fr: "Cinétique enzymatique : Km et Vmax",
    titre_en: "Enzyme Kinetics: Km and Vmax",
    description_fr: "Équations de Michaelis-Menten et de Lineweaver-Burk, facteurs de la vitesse enzymatique",
    description_en: "Michaelis-Menten and Lineweaver-Burk equations, factors affecting enzyme rate",
    icone: "📉",
    learning: LAB13_LEARNING,
    cards: [],
  },
  {
    ordre: 199,
    section: "laboratoire",
    titre_fr: "Test A — Révisions pratiques",
    titre_en: "Test A — Practical Review",
    description_fr: "Épreuve pratique reformulée : conversions, dilutions, titration, pH et tampons",
    description_en: "Reformatted practice exam: unit conversions, dilutions, titration, pH and buffers",
    icone: "📝",
    learning: TEST_A_LEARNING,
    cards: [],
  },
];
