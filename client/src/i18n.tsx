...
const DICT = {
  fr: {
    ...
    trialActiveUntil: "Essai gratuit actif jusqu'au",
    trialEndedBanner: "Ton essai gratuit de 48h est terminé. Abonne-toi pour continuer.",
    submit: "Valider",
    logout: "Déconnexion",
    ...
    libraryEyebrow: "PARCOURS PAR MATIÈRE",
    libraryIntro: "Choisis une matière pour retrouver ses chapitres, ses cours et ses entraînements.",
    subjectChapterCount: (count: number) => `${count} chapitre${count > 1 ? "s" : ""} disponible${count > 1 ? "s" : ""}`,
    subjectExplore: "Explorer",
    subjectView: "Voir la matière",
    backToSubjects: "← Toutes les matières",
    backToSubject: (subject: string) => `← ${subject}`,
    subjectEmptyTitle: "Cette matière se prépare",
    subjectEmptyCopy: (subject: string) => `Les chapitres officiels de ${subject} arriveront ici dès qu’ils seront disponibles.`,
    subjectChapters: "Chapitres disponibles",
    subjectOpenChapter: "Ouvrir le chapitre",
    sectionCours: "Cours",
    sectionCoursCopy: "Fiches de cours, QCM et flashcards par chapitre.",
    sectionLaboratoires: "Laboratoires",
    sectionLaboratoiresCopy: "Protocoles et notes de travaux pratiques.",
    sectionEmptyLabo: "Les laboratoires arrivent bientôt.",
    sectionBack: "← Cours / Laboratoires",
  ...
  en: {
    ...
    passwordRequirements: "At least 8 characters, one uppercase letter, one digit.",
    trialActiveUntil: "Free trial active until",
    trialEndedBanner: "Your 48h free trial has ended. Subscribe to keep going.",
    submit: "Submit",
    logout: "Log out",
    ...
    libraryEyebrow: "STUDY BY SUBJECT",
    libraryIntro: "Choose a subject to access its chapters, courses, and practice activities.",
    subjectChapterCount: (count: number) => `${count} chapter${count > 1 ? "s" : ""} available`,
    subjectExplore: "Explore",
    subjectView: "View subject",
    backToSubjects: "← All subjects",
    backToSubject: (subject: string) => `← ${subject}`,
    subjectEmptyTitle: "This subject is being prepared",
    subjectEmptyCopy: (subject: string) => `Official ${subject} chapters will appear here as soon as they are available.`,
    subjectChapters: "Available chapters",
    subjectOpenChapter: "Open chapter",
    sectionCours: "Courses",
    sectionCoursCopy: "Course sheets, QCM, and flashcards by chapter.",
    sectionLaboratoires: "Labs",
    sectionLaboratoiresCopy: "Lab protocols and practical notes.",
    sectionEmptyLabo: "Labs are coming soon.",
    sectionBack: "← Courses / Labs",
